        ...
        <section>
            ...
            <ul>
                <li>
                    ...
                    <p>You can register to vote by visiting our registration page and filling out the form. You'll need
                        to provide some personal information, including your name, address, and role.</p>
                </li>
                <li>
    ...
    <section class="footer">
        <div class="column">
            <div class="card" id="first">
                ...
                <p>Phone: 7876689129</p>
                <p>Email: 21BCS7851@cuchd.in</p>
            </div>
        </div>
        <div class="column">
            <div class="card">
